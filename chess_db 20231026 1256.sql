...
-- Script date 26.10.2023 12:56:47
...
--
-- Drop table `figure_class`
--
DROP TABLE IF EXISTS figure_class;
...
CREATE TABLE figures (
  ...
  figure_class_id int(11) DEFAULT NULL,
  PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8mb4,
...
--
ALTER TABLE figures
ADD CONSTRAINT FK_figures_figure_class_id FOREIGN KEY (figure_class_id)
REFERENCES figure_class (id);
...
CHARACTER SET utf8mb4,
COLLATE utf8mb4_0900_ai_ci,
COMMENT = 'how figures move, add special options';
...
-- 
-- Dumping data for table figure_class
--
-- Table chess_db.figure_class does not contain any data (it is empty)
